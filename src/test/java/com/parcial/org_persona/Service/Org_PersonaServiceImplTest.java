...
public class Org_PersonaServiceImplTest {
    ...
    @Test
    void testSave() {
        doNothing().when(repository).save(any(Org_Persona.class));
        
        orgPersonaService.save(persona1);
        
        verify(repository, times(1)).save(persona1);
    }
    ...
    void testDeleteById_NoExistente() {
        ...
        assertThrows(RuntimeException.class, () -> orgPersonaService.deleteById(99L));
